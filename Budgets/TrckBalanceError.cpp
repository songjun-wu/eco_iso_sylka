...
void Budget::TrckBalanceError(const Control *ctrl)
{
	...
	Sold = initsnowpack + initponding + initL1 + initL2 + initL3 + initGW;
	...
	if(ctrl->sw_2H){
	  ...
	  Sold_d2H = initsnowpack_d2H + initponding_d2H + 
	...
	if(ctrl->sw_18O){
	  ...
	  Sold_d18O = initsnowpack_d18O + initponding_d18O + 
	...
	if(ctrl->sw_Age){
	  ...
	  Sold_Age = initsnowpack_Age + initponding_Age + 
	  ...
	  Snew_Age = canopy_Age + snowpack_Age + ponding_Age + 
